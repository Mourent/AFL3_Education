                        ...
                        .gesture(
                            DragGesture()
                                .onChanged { gesture in
                                    ...
                                    //                                    if (newPosX > (widthLayar * 0.88) - (boxWidth / 2) && newPosX < (widthLayar * 0.88) + (boxWidth / 2)) &&
                                    //                                        (newPosY > (heightLayar * 0.55) - (boxHeight / 2) && newPosY < (heightLayar * 0.55) + (boxHeight / 2)) {
                                    //                                        print("The piece is inside the box")
                                    //                                        print("Position: \(newPosX), \(newPosY)")
                                    //                                    }
                                ...
                                .onEnded { _ in
                                    ...
                                    //                                    if (piece.currentPosition.x > (widthLayar * 0.88) - (boxWidth / 2) && piece.currentPosition.x < (widthLayar * 0.88) + (boxWidth / 2)) &&
                                    //                                        (piece.currentPosition.y > (heightLayar * 0.55) - (boxHeight / 2) && piece.currentPosition.y < (heightLayar * 0.55) + (boxHeight / 2)) {
                                    //                                        print("The piece is inside the box")
                                    //                                        print("Position: \(piece.currentPosition.x), \(piece.currentPosition.y)")
                                    //                                        orderPieces()
                                    //                                    }
